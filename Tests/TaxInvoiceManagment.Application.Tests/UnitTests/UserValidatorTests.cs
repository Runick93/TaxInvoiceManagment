...
namespace TaxInvoiceManagment.Application.Tests.UnitTests
{
    public class UserValidatorTests
    {
        ...
        {
            var model = new User { Name = "", Email = "test@mail.com", Password = "Valid123!" };
        ...
        {
            var model = new User { Name = "Homero", Email = "invalid-email", Password = "Valid123!" };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new User { Name = "Homero", Email = "homero@mail.com", Password = "123" };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new User { Name = "Homero", Email = "homero@mail.com", Password = "valid123!" };
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(user => user.Password);
        }
        ...
        {
            var model = new User { Name = "Homero", Email = "homero@mail.com", Password = "ValidPassword!" };
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(user => user.Password);
        }
